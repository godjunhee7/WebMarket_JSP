	...
	<div class="container">
		<div class="row" align="center">
			...
			<div class="col-md-4">
				...
				<a href="./productInfo.jsp?id=<%=p.getProductId()%>" class="btn btn-secondary" role="button">
					상세정보 &raquo;
				</a>
				 --%>
				...
				<p>
				<a href="./productInfo.jsp?id=<%=rs.getString("p_id")%>" class="btn btn-secondary" role="button">
					상세정보 &raquo;
				</a>
				</p>
			</div>
